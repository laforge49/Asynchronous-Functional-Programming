...
class CursorTest extends SpecificationWithJUnit {
  "Cursor" should {
    ...
    "Pass the comparision Test" in {
      ...
      var seq1 = new LiteSeqCursor(new LiteReactor(null), new LiteEmptySeq[String, String])
      ...
      seq2 = new LiteSeqCursor(new LiteReactor(null), new LiteEmptySeq[String, String])
      FutureSeq(seq2).first
      seq1 == seq2 must be equalTo true
    }
