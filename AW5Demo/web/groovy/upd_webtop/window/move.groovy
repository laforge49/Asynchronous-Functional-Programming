...
RolonUpdateRequest updateWindow = extendedContext.rolonUpdateRequest("webtop.window.move",context,window,"")
...
extendedContext.updateParameters().put("webtop.window.move.executed",true)