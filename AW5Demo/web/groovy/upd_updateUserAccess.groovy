...
extendedContext.createJournalEntry(context, context.EDIT_USER_ACCESS_NAME + ": " + oldValue + "->" + newValue)
...
extendedContext.addJournalEntryRelationships(userUuid, context.EDIT_USER_ACCESS_UUID)
