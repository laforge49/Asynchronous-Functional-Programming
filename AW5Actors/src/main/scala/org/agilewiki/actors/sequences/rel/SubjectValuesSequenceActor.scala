...
import core.rel.SubjectValuesSequence

class SubjectValuesSequenceAgent(systemContext:SystemComposite, uuid:String)
  ...
  override def wrappedSequence = {
    ...
    else SubjectValuesSequence(rolon, relType)
  }
}


object SubjectValuesSequenceAgent {
  def apply(systemContext: SystemComposite,
    ...
    val sequenceResourceName = ClassName(classOf[SubjectValuesSequenceAgent])
