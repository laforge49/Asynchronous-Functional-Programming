...
import core.rel.SubjectTypesSequence

class SubjectTypesSequenceAgent(systemContext:SystemComposite, uuid:String)
  ...
  override def wrappedSequence = {
    ...
    else SubjectTypesSequence(rolon)
  }
}


object SubjectTypesSequenceAgent {
  def apply(systemContext: SystemComposite,
    ...
    val sequenceResourceName = ClassName(classOf[SubjectTypesSequenceAgent])
