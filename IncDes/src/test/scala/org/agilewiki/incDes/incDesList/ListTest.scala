...
class ListTest extends SpecificationWithJUnit {
  "ListTest" should {
    "Serialize/deserialize" in {
      ...
      val booll0 = IncDesBooleanList(new ReactorMailbox, systemServices)
      ...
      val booll1 = IncDesBooleanList(new ReactorMailbox, systemServices)
      booll1.load(boolb0)
      Future(booll1, Length()) must be equalTo (5)
      val bool1 = Future(booll1, Get(0))
      bool1.isInstanceOf[IncDesBoolean] must beTrue

      val bytesl0 = IncDesBytesList(new ReactorMailbox, systemServices)
      ...
      val bytesl1 = IncDesBytesList(new ReactorMailbox, systemServices)
      ...
      val intl0 = IncDesIntList(new ReactorMailbox, systemServices)
      ...
      val intl1 = IncDesIntList(new ReactorMailbox, systemServices)
      intl1.load(intb0)
      Future(intl1, Length()) must be equalTo (8)
      val int1 = Future(intl1, Get(0))
      int1.isInstanceOf[IncDesInt] must beTrue

      val longl0 = IncDesLongList(new ReactorMailbox, systemServices)
      ...
      val longl1 = IncDesLongList(new ReactorMailbox, systemServices)
      longl1.load(longb0)
      Future(longl1, Length()) must be equalTo (12)
      val long1 = Future(longl1, Get(0))
      long1.isInstanceOf[IncDesLong] must beTrue

      val strl0 = IncDesStringList(new ReactorMailbox, systemServices)
      ...
      val strl1 = IncDesStringList(new ReactorMailbox, systemServices)
      strl1.load(strb0)
      Future(strl1, Length()) must be equalTo (8)
      val str1 = Future(strl1, Get(0))
      str1.isInstanceOf[IncDesString] must beTrue

      val incdesl0 = IncDesIncDesList(new ReactorMailbox, systemServices)
      ...
      val incdesl1 = IncDesIncDesList(new ReactorMailbox, systemServices)
