...
class NavMapTest extends SpecificationWithJUnit {
  "NavMapTest" should {
    "Serialize/deserialize" in {
      ...
      try {
        val booll0 = IncDesIntBooleanMap(systemServices.newSyncMailbox, systemServices)
        ...
        val booll1 = IncDesIntBooleanMap(systemServices.newSyncMailbox, systemServices)
        booll1.load(boolb0)
        Future(booll1, Length()) must be equalTo (9)
        val bool1 = Future(booll1, Get(2))
        bool1.isInstanceOf[IncDesBoolean] must beTrue

        val bytesl0 = IncDesLongBytesMap(systemServices.newSyncMailbox, systemServices)
        ...
        val bytesl1 = IncDesLongBytesMap(systemServices.newSyncMailbox, systemServices)
        ...
        val intl0 = IncDesStringIntMap(systemServices.newSyncMailbox, systemServices)
        ...
        val intl1 = IncDesStringIntMap(systemServices.newSyncMailbox, systemServices)
        intl1.load(intb0)
        Future(intl1, Length()) must be equalTo (14)
        val int1 = Future(intl1, Get("j"))
        int1.isInstanceOf[IncDesInt] must beTrue

        val longl0 = IncDesIntLongMap(systemServices.newSyncMailbox, systemServices)
        ...
        val longl1 = IncDesIntLongMap(systemServices.newSyncMailbox, systemServices)
        longl1.load(longb0)
        Future(longl1, Length()) must be equalTo (16)
        val long1 = Future(longl1, Get(9))
        long1.isInstanceOf[IncDesLong] must beTrue

        val strl0 = IncDesLongStringMap(systemServices.newSyncMailbox, systemServices)
        ...
        val strl1 = IncDesLongStringMap(systemServices.newSyncMailbox, systemServices)
        strl1.load(strb0)
        Future(strl1, Length()) must be equalTo (16)
        val str1 = Future(strl1, Get(-2L))
        str1.isInstanceOf[IncDesString] must beTrue

        val incdesl0 = IncDesStringIncDesMap(systemServices.newSyncMailbox, systemServices)
        ...
        val incdesl1 = IncDesStringIncDesMap(systemServices.newSyncMailbox, systemServices)
